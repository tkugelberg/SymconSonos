...
function get_available_stations(){
  ...
  $RadioStations =  Array(
            ...
            Array( ('name') => "HR-Info",                  ('url') => "x-rincon-mp3radio://www.metafilegenerator.de/HR/hrinfo/mp3/webm.m3u" ),
            ...
            Array( ('name') => "YouFM",                    ('url') => "x-rincon-mp3radio://metafiles.gl-systemhaus.de/hr/youfm_2.m3u" ),
