...
function get_available_stations(){
  ...
  $RadioStations =  Array(
            ...
            Array( ('name') => "Antenne Brandenburg",
                   ('logo') => "http://cdn-radiotime-logos.tunein.com/s25549q.png",
                   ('url')  => "x-rincon-mp3radio://www.antennebrandenburg.de/live.m3u" ),				   
			...
			Array( ('name') => "Radio Zürisee",
                   ('logo') => "http://cdn-radiotime-logos.tunein.com/s80304q.png",
                   ('url')  => "x-rincon-mp3radio://mp3.radio.ch/radiozuerisee128k"),  
            Array( ('name') => "RPR1",
